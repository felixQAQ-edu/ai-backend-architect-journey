 ...
 * 1. 注入 StreamingChatModel（来自 application.yml 的配置）
 * 2. 装配 ChatMemoryProvider（来自 ChatMemoryConfig）
 * 3. 收集所有 @Component 中的 @Tool 方法并注册为 Function Schema
 * 4. 用反射代理生成实现类，注册为 Spring Bean
 * <p>
